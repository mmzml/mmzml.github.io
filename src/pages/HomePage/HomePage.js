    ...
    <div>
      ...
      <CollapsibleSection title="Experiences">
        <CollapsibleSection title="Research" compact>
          <div className={styles.entry}>
            ...
            <p className={styles.entryBody}>
              ...
              ). My work involved investigating the impact of a synthetic
              dataset,{" "}
              <a
                target="_blank"
                rel="noopener noreferrer"
              ...
              , on the performance of a pain detection model for older adults
              with dementia. This included data preprocessing, model training,
              and evaluation. I also contributed to drafting and submitting a{" "}
              <a
          ...
          <div className={styles.entry}>
            <h3 className={styles.entryTitle}>
              ...
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.koziarskilab.com/"
              >
                Koziarski Lab
              </a>
            </h3>
            <p className={styles.entryBody}>
              From September 2025 to February 2026, I worked as a research
              student at the Koziarski Lab, a joint lab at{" "}
              <a
                target="_blank"
                rel="noopener noreferrer"
              ...
              , under the supervision of Dr. Michał Koziarski. My research
              focused on developing deep learning models for detecting cellular
              senescence, with the end goal of determining the efficacy of
              different senomorphic drugs. My responsibilities included data
          ...
          <div className={styles.entry}>
            ...
            <p className={styles.entryBody}>
              ...
              supervision of Professors Alice Gao and Jonathan Calver on a
              project related to the popular card game{" "}
              <a
                target="_blank"
                rel="noopener noreferrer"
              ...
              . We developed an easily installable state-of-the-art game
              simulator that can be found{" "}
              <a
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className={styles.entry}>
            ...
            <p className={styles.entryBody}>
              ...
              . At the lab, I assisted several graduate students with their
              research in human-computer interaction and education. My tasks
              ranged from programming (e.g. React, Python), literature reviews,
        ...
        <CollapsibleSection title="Teaching" compact>
          ...
          <div className={styles.entry}>
            ...
            <p className={styles.entryBody}>
              ...
              Design. My responsibilities included holding weekly office hours
          ...
          <div className={styles.entry}>
            ...
            <p className={styles.entryBody}>
              ...
              two-hour lab sessions, holding office hours, serving as an exam
              invigilator, and grading.
            </p>
          </div>
        </CollapsibleSection>
        ...
        <CollapsibleSection title="Industry" compact>
          <div className={styles.entry}>
            <h3 className={styles.entryTitle}>
              Sep 2023 - Apr 2024: FnS Consulting Inc.
            </h3>
            <p className={styles.entryBody}>
              From September 2023 to April 2024, I worked at FnS Consulting
              Inc., a Vancouver-based software consulting firm, as a Software
              Developer Intern. I worked on their IRM project, designing and
              developing an end-to-end web application. For the front-end I used
              React, HTML/CSS, JavaScript, and TypeScript, while the back-end
              used C#. This experience introduced me to development of
      ...
      <CollapsibleSection title="Education">
        ...
        <div className={styles.eduCard}>
          ...
          <ul className={styles.eduDetails}>
            <li>
              Specialist in Computer Science (Focuses in Artificial Intelligence
              and Computer Vision)
            </li>
        ...
        <div className={styles.eduCard}>
          ...
          <div className={styles.eduDegree}>
            International Baccalaureate &amp; Ontario Secondary School Diploma
          </div>
